...
import { TextBox } from '@/shared/component/TextBox'
...
import { dateStyle, commentStyle, FLOWER_IMAGES, SMALL_IMAGE_SIZE, PADDING_TOP, HORIZONTAL_PADDING, NUMBER_OF_LINES, LINE_HEIGHT, TEXT_SIZE, MIN_TEXT_HEIGHT } from '@/shared/constant/normal'
